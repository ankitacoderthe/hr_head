...
const selectEntries=(data)=>{
  ...
  let queryString=url+"api/getAllSalary?month="+monthObj+"&limit="+limit+"&offset="+offset+"&year="+yearObj+"&status='Pending'&sub_type='Cash'"
  if(employeeFilter.employee_query!='' &&employeeFilter.employee_query!==undefined){
    ...
    if(employeeFilter.location_name!==''){
      ...
      queryString=url+"api/getAllSalary?month="+monthObj+"&year="+yearObj+"&status='Pending'&sub_type='Cash'"
  if(employeeFilter.employee_query!='' &&employeeFilter.employee_query!==undefined){
    queryString+="&employee_query="+employeeFilter.employee_query
  }
    if(employeeFilter.role_name!=''){
...
export default PendingSalaryCash